...
public class Consts
{
    ...
    public static string ValidAudience { get; } = $"account";

    public static OpenIdConnectDiscoveryDocumentConfiguration ValidOpenIdConnectDiscoveryDocumentConfiguration { get; } = OpenIdConnectDiscoveryDocumentConfigurationFactory.Create(ValidIssuer);
